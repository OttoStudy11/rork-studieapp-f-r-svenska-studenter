...
export default function Biologi2() {
  ...
  const storageKey = `@biologi2_progress_${user?.id}`;
      ...
      >
          ...
          <View>
            ...
            >
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Biologi 2</Text>
                <Text style={styles.heroDescription}>
                  Fördjupning i biologi och ekologi
                </Text>
              </View>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/BIOBIO02')}
            activeOpacity={0.7}
          >
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>
              Biologi 2 ger dig fördjupade kunskaper inom cellbiologi, genetik, evolution och ekologi.
            </Text>
          </View>
        </FadeInView>
          ...
          <View style={styles.modalContainer}>
            <View style={[styles.modalContent, { backgroundColor: theme.colors.card }]}>
              ...
              <View style={styles.modalFooter}>
                ...
                <TouchableOpacity
                  style={[styles.modalButton, styles.modalSaveButton, { backgroundColor: '#06B6D4' }]}
...
const styles = StyleSheet.create({
  ...
  moduleCardCompleted: { borderColor: '#06B6D4', borderWidth: 2, borderLeftWidth: 4 },
