...
export default function Fysik1a() {
  ...
  const storageKey = `@fysik1a_progress_${user?.id}`;
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View>
            <LinearGradient colors={['#F59E0B', '#D97706']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.heroCard}>
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Fysik 1a</Text>
                <Text style={styles.heroDescription}>Grundläggande fysik - mekanik och energi</Text>
              </View>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity style={[styles.flashcardsButton, { backgroundColor: theme.colors.card }]} onPress={() => router.push('/flashcards/FYSFYS01a')} activeOpacity={0.7}>
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>Fysik 1a är en kurs i grundläggande fysik som behandlar mekanik, energi och rörelser.</Text>
          </View>
        </FadeInView>
