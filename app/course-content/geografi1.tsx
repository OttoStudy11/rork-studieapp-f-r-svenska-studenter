...
export default function Geografi1() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Geografi 1</Text>
              <Text style={styles.heroDescription}>Jorden och människan</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/GEOGEO01')}
            activeOpacity={0.7}
          >
