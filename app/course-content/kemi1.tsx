...
import { ArrowLeft, BookOpen, Edit3, X as CloseIcon, Award, TrendingUp, Sparkles } from 'lucide-react-native';
...
export default function Kemi1() {
  ...
  const storageKey = `@kemi1_progress_${user?.id}`;
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View>
            <LinearGradient colors={['#10B981', '#059669']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.heroCard}>
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Kemi 1</Text>
                <Text style={styles.heroDescription}>Grundläggande kemi och kemiska reaktioner</Text>
              </View>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity style={[styles.flashcardsButton, { backgroundColor: theme.colors.card }]} onPress={() => router.push('/flashcards/KEMKEM01')} activeOpacity={0.7}>
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>Kemi 1 behandlar atomens uppbyggnad, kemiska reaktioner, och grundläggande kemiska beräkningar.</Text>
          </View>
        </FadeInView>
