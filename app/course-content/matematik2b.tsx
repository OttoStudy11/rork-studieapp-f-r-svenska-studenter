      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>Matematik 2b bygger vidare på Matematik 1b med fokus på funktioner, trigonometri och sannolikhet.</Text>
          </View>
        </FadeInView>
