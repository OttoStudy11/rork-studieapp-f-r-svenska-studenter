...
import { ArrowLeft, Award, TrendingUp, Sparkles } from 'lucide-react-native';
import { FadeInView, SlideInView } from '@/components/Animations';

export default function ModernaSprak() {
      ...
      >
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Moderna språk</Text>
              <Text style={styles.heroDescription}>Språk och kultur</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/MODMOD')}
            activeOpacity={0.7}
          >
