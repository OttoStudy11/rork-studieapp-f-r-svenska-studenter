...
export default function Naturkunskap1a() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Naturkunskap 1a</Text>
              <Text style={styles.heroDescription}>Naturvetenskapens grund</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/NAKNAK01a')}
            activeOpacity={0.7}
          >
