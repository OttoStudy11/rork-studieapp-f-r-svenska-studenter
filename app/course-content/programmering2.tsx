...
export default function Programmering2() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Programmering 2</Text>
              <Text style={styles.heroDescription}>Objektorienterad programmering</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/PRRPRR02')}
            activeOpacity={0.7}
          >
