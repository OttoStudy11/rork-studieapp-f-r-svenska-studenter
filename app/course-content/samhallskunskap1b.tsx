...
export default function Samhallskunskap1b() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Samhällskunskap 1b</Text>
              <Text style={styles.heroDescription}>Samhälle, politik och ekonomi</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/SAMSAM01b')}
            activeOpacity={0.7}
          >
