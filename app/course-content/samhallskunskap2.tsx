...
export default function Samhallskunskap2() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <SlideInView direction="up" delay={100}>
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Samhällskunskap 2</Text>
              <Text style={styles.heroDescription}>Fördjupning i samhällsfrågor</Text>
            </View>
          </LinearGradient>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/SAMSAM02')}
            activeOpacity={0.7}
          >
