      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>Svenska 2 bygger vidare på Svenska 1 med fokus på litteraturanalys, texttyper och språklig medvetenhet.</Text>
          </View>
        </FadeInView>
