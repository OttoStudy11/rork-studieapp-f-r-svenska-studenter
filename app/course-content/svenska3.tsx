...
export default function Svenska3() {
  ...
  const storageKey = `@svenska3_progress_${user?.id}`;
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View>
            <LinearGradient colors={['#EC4899', '#DB2777']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.heroCard}>
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Svenska 3</Text>
                <Text style={styles.heroDescription}>Retorik och språklig medvetenhet</Text>
              </View>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity style={[styles.flashcardsButton, { backgroundColor: theme.colors.card }]} onPress={() => router.push('/flashcards/SVESVE03')} activeOpacity={0.7}>
        ...
        <FadeInView delay={200}>
          <View style={[styles.introSection, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.introText, { color: theme.colors.textSecondary }]}>Svenska 3 fokuserar på retorik, argumentationsteknik och språklig medvetenhet.</Text>
          </View>
        </FadeInView>
