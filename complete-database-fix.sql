-- Complete Database Fix for StudyFlow App
-- This script will fix all database issues including RLS, permissions, and table creation
...
INSERT INTO profiles (name, level, program, purpose, subscription_type) VALUES
('Test User', 'gymnasie', 'Naturvetenskapsprogrammet', 'Förbättra mina betyg', 'free');
...
UNION ALL
SELECT 'Test profiles created:', count(*) FROM profiles;

-- Final message
SELECT 'Database setup complete! All tables created with RLS disabled and full permissions granted.' as status;