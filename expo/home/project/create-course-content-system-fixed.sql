-- =====================================================
-- COMPLETE COURSE CONTENT SYSTEM IMPLEMENTATION (FIXED)
-- =====================================================
...
-- FIXED: Uses proper UUIDs instead of string IDs
...
-- Using proper UUIDs generated at runtime

-- First, let's create the Svenska 1 course with a proper UUID
DO $$
DECLARE
    svenska1_course_id UUID := gen_random_uuid();
...
BEGIN
    ...
    (mod1_id, svenska1_course_id, 'Språkhistoria och språkutveckling', 'Lär dig om svenska språkets historia och utveckling', 1, 20);

    -- Module 2: Textanalys och läsförståelse
    INSERT INTO course_modules (id, course_id, title, description, order_index, estimated_hours) VALUES
    (mod2_id, svenska1_course_id, 'Textanalys och läsförståelse', 'Utveckla färdigheter i att analysera och förstå texter', 2, 25);

    -- Module 3: Skriftlig kommunikation
    INSERT INTO course_modules (id, course_id, title, description, order_index, estimated_hours) VALUES
    (mod3_id, svenska1_course_id, 'Skriftlig kommunikation', 'Lär dig att skriva olika typer av texter', 3, 30);

    -- Module 4: Muntlig kommunikation
    INSERT INTO course_modules (id, course_id, title, description, order_index, estimated_hours) VALUES
    (mod4_id, svenska1_course_id, 'Muntlig kommunikation', 'Utveckla dina färdigheter i muntlig framställning', 4, 15);
    ...
    (lesson1_1_id, mod1_id, svenska1_course_id, 'Fornnordiska och runor', 'Introduktion till svenska språkets äldsta former', 
...
Försök att tyda denna runinskrift: ᚦᚢᚱ ᚢᛁᚴᛁ', 
    ...
    INSERT INTO course_lessons (id, module_id, course_id, title, description, content, lesson_type, order_index, estimated_minutes, learning_objectives) VALUES
    (lesson1_2_id, mod1_id, svenska1_course_id, 'Fornsvenska perioden', 'Svenska språket under medeltiden', 
...
- Regional variation', 
    ...
    (exercise1_id, lesson1_1_id, svenska1_course_id, 'Runkunskap', 'Testa dina kunskaper om runor', 'Svara på frågorna om runor och fornnordiska', 'multiple_choice',
    '[
      {
    ...
    (material1_id, lesson1_1_id, 'Runstenar i Sverige', 'Interaktiv karta över svenska runstenar', 'interactive', 'https://www.raa.se/kulturarv/arkeologi-fornlamningar-och-fynd/runstenar/', true, 1);

    INSERT INTO lesson_materials (id, lesson_id, title, description, material_type, content, is_required, order_index) VALUES
    (material2_id, lesson1_1_id, 'Runornas betydelse', 'Tabell över runornas namn och betydelser', 'document', 
    '| Runa | Namn | Betydelse |
|-------|------|-----------|
| ᚠ | Fe | Boskap, rikedom |
| ᚢ | Ur | Urnoxe, styrka |
...
| ᚨ | As | Gud, visdom |', false, 2);
    ...
    (guide1_id, svenska1_course_id, 'Språkhistorisk översikt', 'Sammanfattning av svenska språkets utveckling', 
...
- 1906: Rättstavningsreformen', 'summary');
    ...
    (tag_historia_id, 'Språkhistoria', 'Innehåll om svenska språkets historia', '#8B5CF6'),
    (tag_runor_id, 'Runor', 'Innehåll om runor och runskrift', '#F59E0B'),
    (tag_grammatik_id, 'Grammatik', 'Grammatiska ämnen', '#10B981');

    -- Link lessons to tags
    INSERT INTO lesson_tags (lesson_id, tag_id) VALUES
    (lesson1_1_id, tag_historia_id),
    (lesson1_1_id, tag_runor_id),
    (lesson1_2_id, tag_historia_id),
    (lesson1_2_id, tag_grammatik_id);
    ...
    (assessment1_id, svenska1_course_id, 'Språkhistoria - Deltest 1', 'Test över fornnordiska och fornsvenska', 'test', 50, 35, 60);
...
-- 8. FIXED: Proper UUID usage throughout