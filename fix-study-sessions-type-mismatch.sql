-- Fix Study Sessions Type Mismatch
-- This fixes the incompatible types between course_id (uuid) and courses.id (text)

-- ===========================================
-- 1. DROP EXISTING STUDY_SESSIONS TABLE
-- ===========================================
DROP TABLE IF EXISTS public.study_sessions CASCADE;

-- ===========================================
-- 2. CREATE STUDY_SESSIONS TABLE WITH TEXT course_id
-- ===========================================
...
-- ===========================================
-- 6. TRIGGER TO UPDATE USER PROGRESS
-- ===========================================
...
-- ===========================================
-- 7. SYNC EXISTING POMODORO SESSIONS
-- ===========================================
...
-- ===========================================
-- 8. POPULATE USER_PROGRESS FROM EXISTING DATA
-- ===========================================
INSERT INTO public.user_progress (
    user_id,
    total_study_time,
...
-- ===========================================
-- 10. HELPER FUNCTIONS FOR STATISTICS
-- ===========================================
...
BEGIN
    RAISE NOTICE '==================================================';
    RAISE NOTICE '✅ Study Sessions Table Fixed!';
    RAISE NOTICE '==================================================';
    RAISE NOTICE 'Changes made:';
    RAISE NOTICE '  ✓ course_id changed from UUID to TEXT';
    RAISE NOTICE '  ✓ Foreign key constraint properly set up';
    RAISE NOTICE '  ✓ All triggers and functions updated';
    RAISE NOTICE '  ✓ Existing data migrated';
    RAISE NOTICE '';
    RAISE NOTICE 'You can now:';
    RAISE NOTICE '  - Plan study sessions with scheduled times';
    RAISE NOTICE '  - Track completed sessions';
    RAISE NOTICE '  - View statistics and streaks';
    RAISE NOTICE '  - All data saves correctly to the database';
    RAISE NOTICE '==================================================';
END $$;
