/**
 * Script för att skapa kursinnehållsstrukturer
 * 
 * Användning:
 * bun run scripts/create-course-templates.ts
 */
...
const courses: CourseTemplate[] = [
  {
    ...
    primaryColor: '#EC4899',
    description: 'Grundläggande svenska med fokus på läsförståelse, skrivande och språkutveckling'
  },
  {
    code: 'engelska5',
    name: 'Engelska 5',
    ...
    primaryColor: '#10B981',
    description: 'Engelska för gymnasieskolan med fokus på kommunikation och språkfärdigheter'
  },
  {
    code: 'historia1b',
    name: 'Historia 1b',
    ...
    primaryColor: '#F97316',
    description: 'Historisk utveckling från antiken till nutid'
  },
  {
    code: 'samhallskunskap1b',
    name: 'Samhällskunskap 1b',
    emoji: '🏛️',
    colors: ['#06B6D4', '#0891B2'],
    primaryColor: '#06B6D4',
    description: 'Samhällsfrågor, demokrati och ekonomi'
  },
  {
    code: 'naturkunskap1a1',
    name: 'Naturkunskap 1a1',
    emoji: '🌿',
    colors: ['#22C55E', '#16A34A'],
    primaryColor: '#22C55E',
    description: 'Grundläggande naturvetenskap med fokus på hållbar utveckling'
  },
  {
    code: 'idrott1',
    ...
    primaryColor: '#EF4444',
    description: 'Fysisk aktivitet, rörelse och hälsa'
  },
];
...
const courseCodeMapping: Record<string, string> = {
  'svenska1': 'SVESVE01',
  'engelska5': 'ENGENG05',
  'historia1b': 'HISHIS01b',
  'samhallskunskap1b': 'SAMSAM01b',
  'naturkunskap1a1': 'NAKNAK01a1',
  'idrott1': 'IDRIDR01',
};

function generateTemplate(course: CourseTemplate): string {
  const functionName = course.code.charAt(0).toUpperCase() + course.code.slice(1);
  const courseCode = courseCodeMapping[course.code];
...
export default function ${functionName}() {
  ...
  const storageKey = \`@${course.code}_progress_\${user?.id}\`;
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        <SlideInView direction="up" delay={100}>
          <View>
            <LinearGradient
              colors={${JSON.stringify(course.colors)}}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
              style={styles.heroCard}
            >
              <View style={styles.heroContent}>
                <Text style={styles.heroIcon}>${course.emoji}</Text>
            ...
            >
              <Edit3 size={20} color="${course.primaryColor}" />
            </TouchableOpacity>
          </View>
        </SlideInView>
        ...
        <FadeInView delay={150}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/flashcards/${courseCode}')}
            activeOpacity={0.7}
          >
            <Sparkles size={24} color="${course.primaryColor}" />
            ...
            <FadeInView key={module.id} delay={300 + index * 100}>
              ...
              >
                <View style={styles.moduleHeader}>
                  ...
                  >
                    {module.completed ? (
                      <CheckCircle size={24} color="${course.primaryColor}" />
                    ) : (
                  ...
                  <View style={styles.moduleTitleContainer}>
                    <Text style={[
                      ...
                      module.completed && { color: '${course.primaryColor}' }
                    ]}>
          ...
          <View style={styles.modalContainer}>
            <View style={[styles.modalContent, { backgroundColor: theme.colors.card }]}>
              ...
              <View style={styles.modalFooter}>
                ...
                <TouchableOpacity
                  style={[styles.modalButton, styles.modalSaveButton, { backgroundColor: '${course.primaryColor}' }]}
...
console.log('Genererar kurssidor...');
courses.forEach(course => {
  const content = generateTemplate(course);
  console.log(`✅ ${course.name} (${course.code}.tsx)`);
  // I verkligheten skulle vi skriva till fil här med fs
});

console.log('\\n✨ Klar! Skapa filer manuellt baserat på utskriften ovan.');
